...
function Userslist2() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('http://localhost/hotelbackend/controllers/api/User/Get/roombook.php');
  ...
  const handleSaveClick = async () => {
    try {
      await axios.put(
        `http://localhost/hotelbackend/controllers/api/admin/put/usebook.php`,
        editFormData
      );
      setUsers((prevUsers) =>
        prevUsers.map((user) =>
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.post(
        `http://localhost/hotelbackend/controllers/api/admin/delete/usebook.php`,
        { id }
      );
